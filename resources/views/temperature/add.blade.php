            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Registro Nuevo de Temperatura</h6>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-4">
                            <div class="card shadow mb-4">
                                <div class="card-body"> 
                                    <form action="{{route('temperature.store')}}" enctype="multipart/form-data" method="POST">
                                        @csrf

                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" name="grados" placeholder="Ejemplo:" required >
