            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Editar Temperatura</h6>
                    </div>
                                ...
                                <div class="card-body"> 
                                    <form action="{{route('temperature.update', $temperature->id)}}" method="POST">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" name="grados" placeholder="Ejemplo:" required value="{{$temperature->grados}}">
                                            <label for="floatingInput">Grados de la Temperatura °C	</label>                     
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" name="location" placeholder="Ejemplo:" required value="{{$temperature->location}}">
                                            <label for="floatingInput">Locacion</label>                     
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input type="datetime-local" class="form-control" name="created_at" placeholder="Ejemplo:" required value="{{$temperature->created_at}}">
