            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Editar Iluminacion</h6>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-4">
                            <div class="card shadow mb-4">
                                <div class="card-body"> 
                                    <form action="{{route('lightning.update', $lightning->id)}}" method="POST">
                                        @csrf
                                        @method("PUT")

                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" name="tuxes" placeholder="Ejemplo:" required value="{{$lightning->tuxes}}">
                                            <label for="floatingInput">Tuxes</label>                     
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" name="location" placeholder="Ejemplo:" required value="{{$lightning->location}}">
                                            <label for="floatingInput">Locacion</label>                     
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input type="datetime-local" class="form-control" name="created_at" placeholder="Ejemplo:" required value="{{$lightning->created_at}}">
