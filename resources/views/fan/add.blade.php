                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-4">
                            <div class="card shadow mb-4">
                                <div class="card-body"> 
                                    <form action="{{route('fan.store')}}" enctype="multipart/form-data" method="POST">
                                        @csrf

                                        <div class="form-floating mb-3">
                                            <input type="datetime-local" class="form-control" name="created_at" placeholder="Ejemplo:" required>
                                            <label for="floatingInput">Hora que se Activo:</label>                     
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input type="datetime-local" class="form-control" name="updated_at" placeholder="Ejemplo:" required>
