            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Editar Ventilador</h6>
                    </div>
                                ...
                                <div class="card-body"> 
                                    <form action="{{route('fan.update', $fan->id)}}" method="POST">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="datetime-local" class="form-control" name="created_at" placeholder="Ejemplo:" required value="{{$fan->created_at}}">
                                            <label for="floatingInput">Hora que se Activo:</label>                     
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input type="datetime-local" class="form-control" name="updated_at" placeholder="Ejemplo:" required value="{{$fan->updated_at}}">
                                            <label for="floatingInput">Hora que se Desactivo	</label>                     
                                        </div>
