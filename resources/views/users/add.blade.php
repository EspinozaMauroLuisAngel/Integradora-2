    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- End of Topbar --> 
                {{-- Formulario de Un nuevo Usuario --}}
                                ...
                                <div class="card-body">
                                    <form action="{{route('users.store')}}" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="file" class="form-control" name="foto" placeholder="jpg" required>
                                            <label class="floatingInput">Foto:</label>
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" name="name" placeholder="Ejemplo: Luis Angel" required>
                                            <label for="floatingInput">Nombre(s):</label>                     
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" name="lastname" placeholder="Ejemplo: Espinoza Mauro" required>
                                            <label for="floatingInput">Apellidos:</label>                     
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input type="date" class="form-control" name="date" placeholder="Ejemplo: 27/12/2003" required>
                                            <label for="floatingInput">Fecha de Nacimiento:</label>                     
                                        </div> 
                                        
                                        <div class="form-floating mb-3">
                                            <input type="email" class="form-control" name="email" placeholder="Ejemplo: al222110870@gmail.com" required>
                                            <label for="floatingInput">Email:</label>                     
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input type="password" class="form-control" name="password" placeholder="jaja" required>
                                            <label for="floatingInput">Contraseña:</label>                     
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" name="role" placeholder="admin o user">
                ...
                {{-- Fin de Formulario de Un nuevo Usuario --}}           
            </div>
            <!-- End of Main Content -->    
            <!-- Footer -->
