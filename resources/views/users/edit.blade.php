                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body"> 
                                    <form action="{{route('users.update', $users->id)}}" method="POST">
                                        ...
                                        <label class="form-label">Imagen: {{$users->foto}} </label><br>
                                        <img src="{{ asset($users->foto) }}" width="130" height="130" >
                                        <input class="form-control" type="file" name="image"><br>

                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" name="name" placeholder="Ejemplo: Luis Angel" required value="{{$users->name}}">
                                            <label for="floatingInput">Nombre(s):</label>                     
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" name="lastname" placeholder="Ejemplo: Espinoza Mauro" required value="{{$users->lastname}}">
                                            <label for="floatingInput">Apellidos:</label>                     
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input type="date" class="form-control" name="date" placeholder="Ejemplo: 27/12/2003" required value="{{$users->date}}">
                                            <label for="floatingInput">Fecha de Nacimiento:</label>                     
                                        </div> 
                                        
                                        <div class="form-floating mb-3">
                                            <input type="email" class="form-control" name="email" placeholder="Ejemplo: al222110870@gmail.com" required value="{{$users->email}}">
                                            <label for="floatingInput">Email:</label>                     
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input type="password" class="form-control" name="password" placeholder="jaja" required value="{{$users->password}}">
                                            <label for="floatingInput">Contraseña:</label>                     
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" name="role" placeholder="admin o user" value="{{$users->role}}">
